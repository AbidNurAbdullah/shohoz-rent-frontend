      ...
      <div className="flex-1 p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-8 rounded-xl shadow-md border-l-8 border-blue-500">
            ...
            <p className="text-4xl font-bold mt-2 font-mono">15</p> 
          ...
          <div className="bg-white p-8 rounded-xl shadow-md border-l-8 border-green-500">
            ...
            <p className="text-4xl font-bold mt-2 font-mono">24</p>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md border-l-8 border-yellow-500">
            ...
            <p className="text-4xl font-bold mt-2 font-mono">03</p>
        ...
        <div className="mt-10 bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">Welcome to the Admin Dashboard. Here you can monitor all activities of Shohoz Rent. From this panel, you can manage user data and property listings.</p>
        </div>
      </div>
    </div>
  );
